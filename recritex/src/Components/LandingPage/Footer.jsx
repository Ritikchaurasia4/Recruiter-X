...
function Footer(){
    ...
    <div className="container" style={{ paddingTop: "75px" }}>
        <div className="row">
            ...
            <div className="col-12 col-sm-6 col-md-3 px-4 topFooter_content mb-4">
                ...
                <p className="mt-4">Address: Lucknow, <br /> Uttar Pradesh, 274404. <br /> <br /> Phone: +91-6306911975 <br />Email: meritik@gmail.com</p>
            </div>
            <div className="col-12 col-sm-6 col-md-3 px-4 topFooter_content mb-4">
    ...
    <div className="row text-secondary px-5 mb-3 mt-4">
        <div className="col-sm-6"> 2024 RecruiterX | This is developed by Ritik Chaurasia</div>
